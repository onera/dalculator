...
object all
  extends DALComposerInstances
    with FMEAComposerInstances
    with FTAComposerInstances
    ...
    with ShowInstances
    with NamerInstances
    with XFTAFileInstances
    with TableComposerInstances
    with Composer.ComposerOps
